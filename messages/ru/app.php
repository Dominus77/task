...
return [
    ...
    'This email is already taken.' => 'Это email уже используется.',
    ...
    'form of password reset' => 'формой сброса',
    ...
    'Email confirm token cannot be blank.' => 'Ключ подтверждения не может быть пустым.',
    'Wrong Email confirm token.' => 'Не верный ключ подтверждения.',
];
